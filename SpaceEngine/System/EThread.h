...
class EThread:public QThread //obolochka dlya potokov qt
{
   Q_OBJECT
private:
    EThreadObject *thread_object; //object potoka
...
public:
    ...
    bool setObject(EThreadObject*,bool*);//ustonavlivoet novii obekt
    ...
    EThread(EThreadObject *Obj,bool*, QObject *ptr=0);//peredovaemii ukazatel dolgen bit pust(=NUUL)
